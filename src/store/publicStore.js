...
const api = {
  unit: '/naf/unit/list',
  corpInfo: '/corp/details',
  userApplyJobFair: '/jobs/jobfair/ticket/apply',
  corpApplyJobFair: '/jobs/jobfair/corp/apply',
  resumeList: '/jobs/resume/list',
  deliver: '/jobs/letter/deliver',
};
